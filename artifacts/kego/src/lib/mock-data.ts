...
export const mockRecoveryChecklist: RecoveryChecklistItem[] = [
  { id: 'c1', title: 'Review project summary and context', description: 'Read through the last known state of the project', completed: true, order: 1 },
  { id: 'c2', title: 'Check pending work and blockers', description: 'Identify what was being worked on and what needs attention', completed: true, order: 2 },
  { id: 'c3', title: 'Review recent decisions', description: 'Understand why recent architectural choices were made', completed: false, order: 3 },
  { id: 'c4', title: 'Check milestone progress', description: 'Understand what has been completed and what remains', completed: false, order: 4 },
  { id: 'c5', title: 'Pull latest code and dependencies', description: 'Get the most recent version from Git', completed: false, order: 5 },
  { id: 'c6', title: 'Start with suggested next action', description: 'Begin with the highest-priority recommended task', completed: false, order: 6 },
]

export const mockRecoveryWorkspace: RecoveryWorkspace = {
  projectId: '1',
  projectSummary: 'FounderOS is a productivity tool for founders combining habit tracking, goal management, and community. This is the marketing website built with Next.js and Vercel, featuring pricing, testimonials, and CMS integration.',
...
export const mockRecommendations: RecoveryRecommendation[] = [
  { projectId: '1', projectName: 'FounderOS Landing Page', reason: 'best-to-resume', explanation: 'Has 92% context completion. Just need to complete waitlist email capture and deploy.', priority: 'high' },
  { projectId: '5', projectName: 'Documentation Site', reason: 'quickest-win', explanation: '85% complete. Good momentum with recent activity. Could ship in 2-3 hours.', priority: 'high' },
  { projectId: '4', projectName: 'Database Migration Script', reason: 'at-risk', explanation: 'No activity in 6 months. This project is at risk of being forgotten completely.', priority: 'medium' },
  { projectId: '2', projectName: 'API Rate Limiter Service', reason: 'momentum-opportunity', explanation: 'Related to current focus. Recent updates mean good context recall.', priority: 'medium' },
]
