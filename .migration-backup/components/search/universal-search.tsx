...
const allResults: SearchResult[] = [
  {
    id: '1',
    title: 'Next.js 16 Framework Decision',
    content: 'Chose Next.js 16 for edge functions, built-in optimizations, and Vercel integration...',
    type: 'decision',
    project: 'KeGo Platform',
    date: '5/11/2026',
    relevance: 98,
  },
  {
    ...
    content: 'PostgreSQL with Drizzle ORM provides type-safe queries and excellent performance...',
    type: 'decision',
    project: 'KeGo Platform',
    date: '5/10/2026',
    relevance: 92,
  ...
  {
    id: '3',
    title: 'Apple Design System Implementation',
    content: 'Premium component library with gesture support and native transitions...',
    type: 'note',
    project: 'KeGo Platform',
    date: '5/15/2026',
    relevance: 85,
  },
  {
    ...
    content: 'Real-time insights on project performance and user engagement metrics...',
    type: 'resource',
    project: 'KeGo Platform',
    date: '5/20/2026',
    relevance: 78,
  ...
  {
    id: '5',
    title: 'Recovery Workspace MVP',
    content: 'Flagship feature combining decision intelligence with recovery metrics...',
    type: 'milestone',
    project: 'KeGo Platform',
    date: '5/25/2026',
    relevance: 88,
  ...
  {
    id: '6',
    title: 'Cross-Project Search Foundation',
    content: 'Semantic search capability enabling discovery across all project memories...',
    type: 'note',
    project: 'KeGo Platform',
    date: '6/20/2026',
    relevance: 95,
...
export function UniversalSearch() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-3xl font-bold">Memory Search</h2>
        <p className="text-muted-foreground mt-1">
          Semantic search across all your projects and memories
        </p>
      </div>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {(['all', 'decision', 'note', 'resource', 'milestone', 'project'] as const).map(
                (type) => (
                  <button
                    key={type}
          ...
          <CardContent className="py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              {searchQuery
                ...
                : 'Search across all your project memories'}
            </p>
          </CardContent>
        </Card>
      ) : (
              ...
              <CardContent className="pt-6">
                <div className="flex items-start justify-between gap-4 mb-2">
                  ...
                  <div className="flex-shrink-0 text-right">
                    ...
                    <p className="text-xs text-muted-foreground mt-2">{result.project}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div>
                <p className="text-2xl font-bold text-primary">
                  {Math.round(filteredResults.reduce((acc, r) => acc + r.relevance, 0) / filteredResults.length)}
                </p>
                <p className="text-xs text-muted-foreground">Avg relevance</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-primary">
                  {new Set(filteredResults.map((r) => r.project)).size}
                </p>
