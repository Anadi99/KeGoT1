...
import { Lightbulb, BookOpen, Link2 } from 'lucide-react'
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">
            No decisions recorded yet. Capture important decisions to strengthen project memory.
          </p>
        </CardContent>
      </Card>
    )
                ...
                {decision.relatedResources && decision.relatedResources.length > 0 && (
                  <div className="flex items-center gap-2 pt-2 border-t border-border">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {decision.relatedResources.length} linked resource{decision.relatedResources.length !== 1 ? 's' : ''}
                    </p>
                  </div>
                )}
              </div>
