...
export function RecoveryConfidence({
  confidence,
  interpretation = true,
}: RecoveryConfidenceProps) {
      ...
      <Tooltip>
        ...
        <TooltipContent>
          ...
          <p className="text-sm mt-1 max-w-xs">
            Measures how ready you are to resume this project immediately based on
            available context completeness.
          </p>
          <div className="mt-2 space-y-1 text-xs">
            <p>81-100%: Ready to resume now</p>
            <p>61-80%: Good readiness</p>
            <p>41-60%: Moderate readiness</p>
            <p>0-40%: Will need documentation review</p>
          </div>
        </TooltipContent>
      </Tooltip>
    </TooltipProvider>
