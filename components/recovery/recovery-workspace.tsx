...
import { RecoveryConfidence } from './recovery-confidence'
...
export function RecoveryWorkspaceComponent({
  project,
  workspace,
  ...
  return (
    <div className="space-y-6">
      ...
      {project.scoreBreakdown && (
        <ScoreBreakdown breakdown={project.scoreBreakdown} totalScore={project.resumeScore} />
      )}
      ...
      <Card>
        ...
        <CardContent>
          <div className="whitespace-pre-wrap text-sm leading-relaxed text-foreground font-mono bg-muted/50 p-4 rounded-lg">
            {workspace.completedWork}
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="whitespace-pre-wrap text-sm leading-relaxed text-foreground font-mono bg-muted/50 p-4 rounded-lg">
            {workspace.importantResources}
          </div>
        </CardContent>
      </Card>

      {/* Decision Intelligence */}
      {workspace.decisions && workspace.decisions.length > 0 && (
        <DecisionIntelligence decisions={workspace.decisions} />
      )}

      {/* Milestones */}
      {workspace.milestones && workspace.milestones.length > 0 && (
        <Milestones milestones={workspace.milestones} />
      )}

      {/* Recovery Checklist */}
      {workspace.recoveryChecklist && workspace.recoveryChecklist.length > 0 && (
        <RecoveryChecklist items={workspace.recoveryChecklist} />
      )}
