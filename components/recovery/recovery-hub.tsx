...
const momentumData: MomentumData[] = [
  { date: 'Jun 19', score: 65, activities: 2, decisions: 1 },
  { date: 'Jun 20', score: 72, activities: 3, decisions: 2 },
  { date: 'Jun 21', score: 58, activities: 1, decisions: 1 },
  { date: 'Jun 22', score: 78, activities: 4, decisions: 2 },
  { date: 'Jun 23', score: 85, activities: 5, decisions: 3 },
  { date: 'Jun 24', score: 88, activities: 5, decisions: 3 },
  { date: 'Jun 25', score: 92, activities: 6, decisions: 4 },
]

const dailySummaries: DailySummary[] = [
  { date: 'Today (Jun 25)', itemsReviewed: 12, decisionsLogged: 2, timeSpent: 45, focusArea: 'Architecture Design' },
  { date: 'Jun 24', itemsReviewed: 10, decisionsLogged: 3, timeSpent: 52, focusArea: 'Feature Planning' },
  { date: 'Jun 23', itemsReviewed: 15, decisionsLogged: 2, timeSpent: 38, focusArea: 'Documentation' },
]
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="text-xs text-muted-foreground mt-2">↑ 7 points from yesterday</p>
          </CardContent>
        </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-3 gap-4 mt-6">
            {momentumData.slice(-3).map((data, i) => (
              <div key={i} className="p-3 rounded-lg bg-muted/50">
                <p className="text-xs text-muted-foreground">{data.date}</p>
                <p className="text-lg font-bold text-blue-500">{data.score}</p>
            ...
            <div key={i} className="border border-muted rounded-lg p-4 hover:bg-muted/50 transition-colors">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="p-2 rounded bg-muted/50">
                  ...
                  <p className="text-sm font-semibold">{summary.itemsReviewed}</p>
                </div>
                <div className="p-2 rounded bg-muted/50">
                  <p className="text-xs text-muted-foreground">Decisions Logged</p>
                  <p className="text-sm font-semibold">{summary.decisionsLogged}</p>
                </div>
              </div>
            </div>
          ))}
          ...
          {[
            {
              ...
              description: 'Review the decision about Next.js migration from docs',
              priority: 'high',
              date: '2 hours ago',
            },
            {
              title: 'Update Project Timeline',
              description: 'Milestone progress needs documentation',
              priority: 'medium',
              date: '5 hours ago',
            },
            {
              title: 'Resource Link Validation',
              description: 'Check if all archived documentation links are still valid',
              priority: 'low',
              date: '1 day ago',
            },
          ].map((item, i) => (
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3">
            {[
              { date: 'Jun 25, 2026 - 14:30', status: 'Architecture finalized', progress: 85 },
              { date: 'Jun 24, 2026 - 11:15', status: 'Feature planning complete', progress: 75 },
              { date: 'Jun 23, 2026 - 09:45', status: 'Initial design phase', progress: 65 },
            ].map((snapshot, i) => (
